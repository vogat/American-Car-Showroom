...
export default function App() {
	...
	async function getItems() {
		try {
			const response = await axios.get('https://meltinpot.onrender.com/api/items/');
	...
	async function getOrders() {
		try {
			const response = await axios.get('https://meltinpot.onrender.com/api/orders/');
	...
	async function handleCreate(createdItem) {
		try {
			const response = await axios.post('https://meltinpot.onrender.com/api/items/', createdItem);
	...
	async function handleDelete(deletedItem) {
		try {
			await axios.delete(`https://meltinpot.onrender.com/api/items/${deletedItem._id}/`);
	...
	async function handleEdit(editedItem) {
		try {
			await axios.put(`https://meltinpot.onrender.com/api/items/${editedItem._id}/`, editedItem);
